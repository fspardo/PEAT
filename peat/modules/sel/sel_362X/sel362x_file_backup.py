...
def form_generate(password: str, token: str) -> dict[str, str]:
    """
...
def form_export(token: str) -> dict[str, str]:
    """
...
def get_password(dev: DeviceData):
    """
...
class SystemSettingsPoller:
    ...
    def queue(self) -> bool:
        ...
        # Get the file from the device data
...
def pull_file_management(dev: DeviceData, http: HTTP362X) -> dict[str, Any]:
    ...
    ssp: SystemSettingsPoller = dev._cache[SystemSettingsPoller]
